...
var TabPane = React119.forwardRef(({
  ...
  return (0, import_jsx_runtime116.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime116.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime116.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Table = React120.forwardRef(({
  ...
  const classes = (0, import_classnames81.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
...
var ToastFade = React122.forwardRef((props, ref) => (0, import_jsx_runtime120.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React126.forwardRef(({
  ...
  return (0, import_jsx_runtime124.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime124.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
