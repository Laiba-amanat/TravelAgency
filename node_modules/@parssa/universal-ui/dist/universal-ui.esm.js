import React, { useState, useEffect, createContext, useContext, useMemo, forwardRef } from 'react';
import { Provider, Root as Root$3, Trigger as Trigger$2, Portal as Portal$2, Content as Content$3, Arrow as Arrow$1 } from '@radix-ui/react-tooltip';
import { extendTailwindMerge } from 'tailwind-merge';
import { Root, Portal, Overlay, Content, Title, Description } from '@radix-ui/react-dialog';
import { Root as Root$1, Trigger, Portal as Portal$1, Content as Content$1, Arrow } from '@radix-ui/react-popover';
import { Root as Root$2, List, Trigger as Trigger$1, Content as Content$2 } from '@radix-ui/react-tabs';
import { Root as Root$4, Indicator } from '@radix-ui/react-checkbox';
import { Root as Root$5, Trigger as Trigger$3, Icon as Icon$1, Value, Portal as Portal$3, Content as Content$4, ScrollUpButton, Viewport, ScrollDownButton, Item, ItemIndicator, ItemText } from '@radix-ui/react-select';
...
var UniversalUIConfigContext = /*#__PURE__*/createContext({
  components: {},
  ssr: false
});
var UniversalUIConfigProvider = function UniversalUIConfigProvider(_ref) {
  ...
  var _useState = useState(!(config != null && config.ssr) ? config : {
    components: {}
  }),
      v = _useState[0],
      setV = _useState[1];
  ...
  return React.createElement(UniversalUIConfigContext.Provider, {
    value: v != null ? v : {
      components: {}
    }
  }, React.createElement(ThemeProvider, Object.assign({}, config == null ? void 0 : (_config$providers = config.providers) == null ? void 0 : _config$providers.theme), React.createElement(Provider, Object.assign({}, config == null ? void 0 : (_config$providers2 = config.providers) == null ? void 0 : _config$providers2.tooltip), children)));
};
var useUniversalUIConfig = function useUniversalUIConfig() {
  return useContext( // @ts-ignore
  typeof createContext === 'function' ? UniversalUIConfigContext : {
...
var twMerge = /*#__PURE__*/extendTailwindMerge({
  classGroups: {
    'font-size': [{
      text: ['size']
    }],
...
var PopoverRoot = function PopoverRoot(_ref) {
  ...
  return React.createElement(Root$1, Object.assign({}, rest));
};
...
var PopoverContent = function PopoverContent(props) {
  ...
  return React.createElement(Portal$1, {
    container: container != null ? container : body
  }, React.createElement(ThemeProvider, Object.assign({}, rest, {
    ...
    dark: dark,
    className: classNames
  }), props.children, !arrowClassNames.includes('fill-transparent') && React.createElement(Arrow, {
...
var TabsRoot = function TabsRoot(_ref) {
  ...
  return React.createElement(Root$2, Object.assign({}, rest));
};
...
var TabsTrigger = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  return React.createElement(Trigger$1, {
    value: value,
    asChild: true
  }, render({
    // @ts-ignore
...
var TabsContent = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  return React.createElement(Content$2, {
    value: value,
    asChild: true
  }, render({
    // @ts-ignore
...
var TooltipRoot = function TooltipRoot(_ref) {
  ...
  return React.createElement(Root$3, Object.assign({}, rest, {
...
var TooltipTrigger = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  return React.createElement(Trigger$2, {
    asChild: true
  }, render({
    // @ts-ignore
    props: _extends({
...
var TooltipContent = function TooltipContent(props) {
  ...
  return React.createElement(Portal$2, {
    ...
    dark: dark,
    className: classNames
  }), props.children, !arrowClassNames.includes('fill-transparent') && React.createElement(Arrow$1, {
    className: arrowClassNames
  })));
};
...
var ICON_MAP = {
  ...
  selector: /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/React.createElement("path", {
...
var CheckboxRoot = /*#__PURE__*/forwardRef(function (props, ref) {
  var size = props.size,
      theme = props.theme,
      dark = props.dark,
      className = props.className,
  ...
  return React.createElement(Root$4, Object.assign({}, rest, {
    className: classNames,
    ref: ref,
    "data-theme": theme,
    "data-dark": dark,
    "data-size": size
  }), React.createElement(Indicator, null, React.createElement(Icon, {
    name: "check",
...
// ! For internal use only, do not export from index.ts
var InputGroupContext = /*#__PURE__*/createContext(null);
var useInputGroupContext = function useInputGroupContext() {
  return useContext(InputGroupContext);
};

var InputIcon = /*#__PURE__*/forwardRef(function (props, ref) {
...
var ButtonRoot = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  return render({
    ...
    props: _extends({
      ...
      'data-theme': theme,
      'data-dark': dark,
      children: React.createElement(React.Fragment, null, leadingIcon && React.createElement(InputIcon, {
        type: "leading"
      }, leadingIcon), icon ? React.createElement("span", {
        className: "sr-only"
      }, children) : children, icon && React.createElement(InputIcon, {
        type: "center"
      }, icon), trailingIcon && React.createElement(InputIcon, {
        type: "trailing"
      }, trailingIcon))
    }, rest),
...
var Input = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  return render({
    props: {
      ...
      children: React.createElement(React.Fragment, null, leadingIcon && React.createElement(InputIcon, {
        type: "leading"
      }, leadingIcon), React.createElement("input", Object.assign({}, rest, {
        className: inputClassNames,
        ref: inputRef
      })), trailingIcon && React.createElement(InputIcon, {
        type: "trailing"
      }, trailingIcon))
    },
...
var SelectRoot = function SelectRoot(props) {
  ...
  return React.createElement(Root$5, Object.assign({}, rest), React.createElement(SelectContext.Provider, {
    value: {
      size: size,
      theme: theme,
      dark: dark
...
var SelectTrigger = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  var variant = props.variant,
      ...
      trailingIcon = _props$trailingIcon === void 0 ? React.createElement(Icon, {
    name: "selector"
  }) : _props$trailingIcon,
  ...
  return React.createElement(Trigger$3, {
    asChild: true
  }, render({
    // @ts-ignore
    props: _extends({
      ...
      }, leadingIcon && React.createElement(Icon$1, {
        asChild: true
      }, React.createElement(InputIcon, {
        type: "leading"
      }, leadingIcon)), React.createElement(Value, {
        placeholder: rest.placeholder || 'Select an option...',
        className: "inline flex-1"
      }, children), trailingIcon && React.createElement(Icon$1, {
        asChild: true
      }, React.createElement(InputIcon, {
        type: "trailing",
        className: "ml-auto"
...
var SelectPanel = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  ...
  }, rest), React.createElement(Content$4, {
    className: classNames
  ...
  }))), React.createElement(Viewport, null, children), React.createElement(ScrollDownButton, {
    className: "grid place-items-center"
  }, React.createElement(InputIcon, {
    type: "center"
  }, React.createElement(Icon, {
...
var SelectItem = /*#__PURE__*/forwardRefWithAs(function (props, ref) {
  var className = props.className,
      ...
      trailingIcon = _props$trailingIcon2 === void 0 ? React.createElement(Icon, {
    name: "check"
  ...
  return React.createElement(Item, Object.assign({}, rest, {
    value: value,
    asChild: true
  }), render({
    props: {
      className: classNames,
      'data-theme': theme,
      children: React.createElement(React.Fragment, null, leadingIcon && React.createElement(ItemIndicator, {
        asChild: true
      }, React.createElement(InputIcon, {
        type: "leading"
      }, leadingIcon)), React.createElement(ItemText, {
        asChild: true
      }, React.createElement("span", {
        className: textClassNames
      }, children)), trailingIcon && React.createElement(ItemIndicator, {
        asChild: true
      }, React.createElement(InputIcon, {
        type: "trailing",
        className: "ml-auto"
  ...
  return render({
    props: {
      ...
      children: React.createElement(React.Fragment, null, leadingIcon && React.createElement(InputIcon, {
        ...
        type: "leading"
      }, leadingIcon), React.createElement("textarea", Object.assign({}, rest, {
...
export { Button, Card, Checkbox, Dialog, Input, InputGroup, Popover, Select, Tabs, Text, TextArea, ThemeProvider, Tooltip, UniversalUIConfigContext, UniversalUIConfigProvider, useUniversalUIConfig };
//# sourceMappingURL=universal-ui.esm.js.map
