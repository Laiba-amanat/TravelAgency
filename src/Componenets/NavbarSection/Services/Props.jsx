...
function Props(props) {
    ...
    return (
        ...
        >
            <div  data-aos='fadeInUp'  className='p-4 text-start mt-10 mx-auto md:mx-0 animate__animated animate__fadeInUp rounded-xl' style={{
                backgroundColor: currentImg ? '#fbb552' : '#F7FAFC',
