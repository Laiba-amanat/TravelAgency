...
const Carousal = () => {
  return (
    ...
    <div className="flex justify-evenly  h-[650px]">
      <div className=" w-500 h-[500px] p-5"><Link to="/Page2"><img
        className="w-500 h-[500px]"
        src="https://img.freepik.com/free-photo/backpack-thailand-outdoors-water-woman_1122-2291.jpg?ga=GA1.1.62612920.1739082954&semt=ais_incoming"
        width={500}
        height={500}
        alt="First slide"
      /> </Link></div>
      <div className="w-300 h-[500px]  flex   justify-evenly items-center ">
          ...
          <Link to="/Page2"> <img
        className="w-300 h-[400px]"
        src="https://img.freepik.com/free-photo/outdoor-picture-stone-hinduism-monument_1150-1215.jpg?ga=GA1.1.62612920.1739082954&semt=ais_incoming"
        alt="First slide"
        width={300}
        height={400}
      /> </Link>
